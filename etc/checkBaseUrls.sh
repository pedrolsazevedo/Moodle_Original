...
BASE_TEMPLATE_URL=https://raw.githubusercontent.com/psilvaazevedo/Moodle_Original/$CURRENT_BRANCH/nested/
echo "Base template URL: $BASE_TEMPLATE_URL"

SCRIPT_LOCATION=https://raw.githubusercontent.com/psilvaazevedo/Moodle_Original/$CURRENT_BRANCH/scripts/
